...
Release-identitás: a végső candidate csak akkor tekinthető v5.3.5-nek, ha a kanonikus `cpap.version.APP_VERSION` pontosan `5.3.5`, a `RELEASE_NOTES.md` első kiadási szekciója `# SleepMate 5.3.5`, és az exact-SHA VERIFIED ZIP/MSI/runtime metadata ugyanezt a verziót és ugyanazt a commit SHA-t igazolja. A `v534` nevű regressziótesztek és frontend/cache markerek történeti generációazonosítók maradhatnak; ezek nem írhatják felül a kanonikus 5.3.5 alkalmazásverziót.