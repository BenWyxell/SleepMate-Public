...
def test_merged_sleep_keeps_exact_constituent_session_intervals():
    class Dataset:
        ...
        def sessions(self, day):
            return [
                SimpleNamespace(
                    start=datetime.fromisoformat("2026-08-23T23:00:00"),
                    end=datetime.fromisoformat("2026-08-24T01:00:00"),
                    duration_s=7200,
                ),
                SimpleNamespace(
                    start=datetime.fromisoformat("2026-08-24T01:20:00"),
                    end=datetime.fromisoformat("2026-08-24T05:20:00"),
                    duration_s=14400,
                ),
            ]
    ...
    assert [x["start"] for x in payload["session_details"]] == [
        "2026-08-23T23:00:00",
        "2026-08-24T01:20:00",
    ]
    assert [x["end"] for x in payload["session_details"]] == [
        "2026-08-24T01:00:00",
        "2026-08-24T05:20:00",
    ]
