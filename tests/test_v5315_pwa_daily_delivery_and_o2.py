...
def test_packaged_dashboard_pwa_css_is_build_versioned():
    ...
    assert "/dashboard-pwa-v5312.css?v=5.3.27" in text("web/index.html")
    assert "shutil.copytree(WEB_SOURCE, WEB_GENERATED)" in spec
    assert "/dashboard-pwa-v5312.css?v=5.3.27" in text("web/service-worker-v508-base.js")
    assert "/dashboard-pwa-v5312.css?v=5.3.27" in text("web/service-worker.js")
