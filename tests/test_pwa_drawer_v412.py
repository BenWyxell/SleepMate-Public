...
assert "const CACHE='sleepmate-shell-v5.0.0'" in sw
assert "const codeAsset=url.pathname==='/style.css'||url.pathname==='/app.js'" in sw
assert 'APP_VERSION' in app and 'from cpap.version import APP_NAME, APP_VERSION' in app
print('PASS: v5.0.0 stable PWA drawer + versioned shell/network-first code assets')
