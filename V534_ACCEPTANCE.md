...
- A completed SleepSync import must update matching O₂/CPAP views automatically without requiring a manual refresh.
...
5. real Microsoft Edge acceptance against that VERIFIED portable artifact.
