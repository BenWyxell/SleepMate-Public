...
def assert_current_pwa(page: Page, backend_log: Path) -> None:
    ...
    while time.monotonic() < deadline:
        ...
        if "sleepmate-shell-v5.3.25" in state["caches"] and state["active"] == "activated":
            break
...
def main() -> int:
    parser = argparse.ArgumentParser(description="SleepMate 5.3.25 browser/PWA acceptance")
    ...
    print("SleepMate 5.3.25 browser/PWA acceptance OK")
    return 0
