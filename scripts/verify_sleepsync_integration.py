...
script_order = [
    "/app-core.js?v=5.3.27",
    "/app-engine119.js?v=5.3.27",
    "/sleepsync-hydration-v529.js?v=5.3.27",
    "/sleepsync-polish.js?v=5.3.27",
]
...
require("sleepmate-aurora.css?v=5.3.27" in UI, "core Aurora stylesheet is not packaged")
...
require('APP_VERSION = "5.3.27"' in VERSION, "release version is not 5.3.27")
require('BUILD_CHANNEL = "stable"' in VERSION, "release channel is not stable")
require("const SHELL_CACHE='sleepmate-shell-v5.3.27'" in SERVICE_WORKER, "current shell cache generation is missing")
require("const API_CACHE='sleepmate-api-v5.3.27'" in SERVICE_WORKER, "current API cache generation is missing")
for asset in (
